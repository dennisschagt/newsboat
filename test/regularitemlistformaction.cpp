...
TEST_CASE("RegularItemList: OP_OPEN displays article using an external pager",
	"[RegularItemListFormAction]")
{
	ConfigPaths paths;
	Controller c(paths);
	newsboat::View v(&c);
...
TEST_CASE("RegularItemList: OP_PURGE_DELETED purges previously deleted items",
	"[RegularItemListFormAction]")
{
	ConfigPaths paths;
	Controller c(paths);
...
TEST_CASE(
	"RegularItemList: OP_OPENBROWSER_AND_MARK passes the url to the browser and marks read",
	"[RegularItemListFormAction]")
{
	ConfigPaths paths;
	Controller c(paths);
...
TEST_CASE(
	"RegularItemList: OP_OPENBROWSER_AND_MARK does not mark read when browser fails",
	"[RegularItemListFormAction]")
{
	ConfigPaths paths;
	Controller c(paths);
...
TEST_CASE("RegularItemList: OP_OPENINBROWSER passes the url to the browser",
	"[RegularItemListFormAction]")
{
	ConfigPaths paths;
	Controller c(paths);
...
TEST_CASE("RegularItemList: OP_OPENALLUNREADINBROWSER passes the url list to the browser",
	"[RegularItemListFormAction]")
{
	ConfigPaths paths;
	Controller c(paths);
...
TEST_CASE(
	"RegularItemList: OP_OPENALLUNREADINBROWSER_AND_MARK passes the url list to the browser "
	"and marks them read",
	"[RegularItemListFormAction]")
{
	ConfigPaths paths;
...
TEST_CASE("RegularItemList: OP_SHOWURLS shows the article's properties",
	"[RegularItemListFormAction]")
{
	ConfigPaths paths;
	Controller c(paths);
...
TEST_CASE("RegularItemList: OP_BOOKMARK pipes articles url and title to bookmark-command",
	"[RegularItemListFormAction]")
{
	ConfigPaths paths;
	Controller c(paths);
...
TEST_CASE("RegularItemList: OP_EDITFLAGS arguments are added to an item's flags",
	"[RegularItemListFormAction]")
{
	ConfigPaths paths;
	Controller c(paths);
...
TEST_CASE("RegularItemList: OP_SAVE writes an article's attributes to the specified file",
	"[RegularItemListFormAction]")
{
	ConfigPaths paths;
	Controller c(paths);
...
TEST_CASE("RegularItemList: OP_HELP command is processed",
	"[RegularItemListFormAction]")
{
	ConfigPaths paths;
	Controller c(paths);
...
TEST_CASE("RegularItemList: OP_HARDQUIT command is processed",
	"[RegularItemListFormAction]")
{
	ConfigPaths paths;
	Controller c(paths);
...
TEST_CASE("RegularItemList: Navigate back and forth using OP_NEXT and OP_PREV",
	"[RegularItemListFormAction]")
{
...
TEST_CASE("RegularItemList: OP_TOGGLESHOWREAD switches the value of show-read-articles",
	"[RegularItemListFormAction]")
{
	ConfigPaths paths;
	Controller c(paths);
...
TEST_CASE("RegularItemList: OP_PIPE_TO pipes an article's content to an external command",
	"[RegularItemListFormAction]")
{
	ConfigPaths paths;
	Controller c(paths);
...
TEST_CASE("RegularItemList: OP_OPENINBROWSER does not result in itemlist invalidation",
	"[RegularItemListFormAction]")
{
	ConfigPaths paths;
	Controller c(paths);
