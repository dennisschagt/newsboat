...
$(NEWSBOATLIB_OUTPUT): $(RUST_SRCS) Cargo.lock include/matchable.h
...
$(NEWSBOAT): $(NB_DEPS)
	$(CXX) $(CXXFLAGS) -o $(NEWSBOAT) $(NEWSBOAT_OBJS) $(NEWSBOAT_LIBS) src/matchable.o $(LDFLAGS)

$(PODBOAT): $(LIB_OUTPUT) $(NEWSBOATLIB_OUTPUT) $(PODBOAT_OBJS) $(FILTERLIB_OUTPUT)
	$(CXX) $(CXXFLAGS) -o $(PODBOAT) $(PODBOAT_OBJS) $(PODBOAT_LIBS) src/matchable.o $(LDFLAGS)
...
doc/xhtml/newsboat.html: doc/chapter-dialog-titles.asciidoc
...
doc/$(NEWSBOAT).1: doc/manpage-newsboat.asciidoc doc/chapter-firststeps.asciidoc \
		...
		doc/chapter-dialog-titles.asciidoc doc/chapter-killfiles.asciidoc \
		doc/chapter-podcasts.asciidoc doc/man.rb
